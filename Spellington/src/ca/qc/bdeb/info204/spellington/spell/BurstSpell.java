...
public class BurstSpell extends ProjectileSpell {
    ...
    public BurstSpell(int id, ElementalType element, int uses, Animation animation, float size, float initSpeed, float gravModifier, int damage, float angle, int projectileNumber) {
        super(id, element, uses, animation, size, initSpeed, gravModifier, damage);
