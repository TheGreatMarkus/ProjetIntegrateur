...
public class SpellBookState extends BasicGameState {
    ...
    public void update(GameContainer gc, StateBasedGame game, int delta) throws SlickException {
        ...
        switch (pageState) {
            ...
            case 1:
                ...
                if (mnuItemBar.getHoveredOver() && triedToClick) {
                    switch (spellsSubPageState) {
                        ...
                        case 1:
                            if (SpellingSystem.knownSpells.size() >= 9) {
                                spellKind = 8;
                                showRightPage = true;
                            } else {
                                showRightPage = false;
                        ...
                        case 2:
                            if (SpellingSystem.knownSpells.size() >= 17) {
                                spellKind = 16;
                                showRightPage = true;
                            } else {
                                showRightPage = false;
                ...
                if (mnuItemBar2.getHoveredOver() && triedToClick) {
                    switch (spellsSubPageState) {
                        ...
                        case 1:
                            if (SpellingSystem.knownSpells.size() >= 10) {
                                spellKind = 9;
                                showRightPage = true;
                            } else {
                                showRightPage = false;
                        ...
                        case 2:
                            if (SpellingSystem.knownSpells.size() >= 18) {
                                spellKind = 17;
                                showRightPage = true;
                            } else {
                                showRightPage = false;
                ...
                if (mnuItemBar3.getHoveredOver() && triedToClick) {
                    switch (spellsSubPageState) {
                        case 0:
                            ...
                            break;
                        case 1:
                            if (SpellingSystem.knownSpells.size() >= 11) {
                                spellKind = 10;
                                showRightPage = true;
                            } else {
                                showRightPage = false;
                        ...
                        case 2:
                            if (SpellingSystem.knownSpells.size() >= 19) {
                                spellKind = 18;
                                showRightPage = true;
                            } else {
                                showRightPage = false;
                ...
                if (mnuItemBar4.getHoveredOver() && triedToClick) {
                    switch (spellsSubPageState) {
                        ...
                        case 1:
                            if (SpellingSystem.knownSpells.size() >= 12) {
                                spellKind = 11;
                                showRightPage = true;
                            } else {
                                showRightPage = false;
                        ...
                        case 2:
                            if (SpellingSystem.knownSpells.size() >= 20) {
                                spellKind = 19;
                                showRightPage = true;
                            } else {
                                showRightPage = false;
                ...
                if (mnuItemBar5.getHoveredOver() && triedToClick) {
                    switch (spellsSubPageState) {
                        ...
                        case 1:
                            if (SpellingSystem.knownSpells.size() >= 13) {
                                spellKind = 12;
                                showRightPage = true;
                            } else {
                                showRightPage = false;
                        ...
                        case 2:
                            if (SpellingSystem.knownSpells.size() >= 21) {
                                spellKind = 20;
                                showRightPage = true;
                            } else {
                                showRightPage = false;
                ...
                if (mnuItemBar6.getHoveredOver() && triedToClick) {
                    switch (spellsSubPageState) {
                        ...
                        case 1:
                            if (SpellingSystem.knownSpells.size() >= 14) {
                                spellKind = 13;
                                showRightPage = true;
                            } else {
                                showRightPage = false;
                        ...
                        case 2:
                            if (SpellingSystem.knownSpells.size() >= 22) {
                                spellKind = 21;
                                showRightPage = true;
                            } else {
                                showRightPage = false;
                ...
                if (mnuItemBar7.getHoveredOver() && triedToClick) {
                    switch (spellsSubPageState) {
                        ...
                        case 1:
                            if (SpellingSystem.knownSpells.size() >= 15) {
                                spellKind = 14;
                                showRightPage = true;
                            } else {
                                showRightPage = false;
                        ...
                        case 2:
                            if (SpellingSystem.knownSpells.size() >= 23) {
                                spellKind = 22;
                                showRightPage = true;
                            } else {
                                showRightPage = false;
                ...
                if (mnuItemBar8.getHoveredOver() && triedToClick) {
                    switch (spellsSubPageState) {
                        ...
                        case 1:
                            if (SpellingSystem.knownSpells.size() >= 16) {
                                spellKind = 15;
                                showRightPage = true;
                            } else {
                                showRightPage = false;
                        ...
                        case 2:
                            if (SpellingSystem.knownSpells.size() >= 24) {
                                spellKind = 23;
                                showRightPage = true;
                            } else {
                                showRightPage = false;
            ...
            case 2:
                ...
                if (mnuItemBar2.getHoveredOver() && triedToClick) {
                    if (SpellingSystem.potionList.size() >= 2) {
                        potionKind = 1;
                        showRightPage = true;
                    } else {
                        showRightPage = false;
                ...
                if (mnuItemBar3.getHoveredOver() && triedToClick) {
                    if (SpellingSystem.potionList.size() >= 3) {
                        potionKind = 2;
                        showRightPage = true;
                    } else {
                        showRightPage = false;
                ...
                if (mnuItemBar4.getHoveredOver() && triedToClick) {
                    if (SpellingSystem.potionList.size() >= 4) {
                        potionKind = 3;
                        showRightPage = true;
                    } else {
                        showRightPage = false;
        ...
        switch (spellsSubPageState) { //Spell name title attributed in the information rectangles according to the page where the player stands
            case 0:
                for (infoBarFill = 0, i = 0; i < 8; infoBarFill++, i++) {
                    if (infoBarFill < SpellingSystem.knownSpells.size()) {
                        infoList.set(i, SpellingSystem.knownSpells.get(i).getName());
                    } else {
                        infoList.set(i, " ");
                    }
                }
            ...
            case 1:
                for (infoBarFill = 8, i = 0; i < 8; infoBarFill++, i++) {
                    if (infoBarFill < SpellingSystem.knownSpells.size()) {
                        infoList.set(i, SpellingSystem.knownSpells.get(infoBarFill).getName());
                    } else {
                        infoList.set(i, " ");
                    }
                }
    ...
    private void displayPotionsLeftPage(Graphics g, GameContainer gc) throws SlickException {
        ...
        for (infoBarFill = 0, i = 0; i < 4; infoBarFill++, i++) {
            if (infoBarFill < SpellingSystem.potionList.size()) {
                infoList.set(i, SpellingSystem.potionList.get(i).getName());
            } else {
                infoList.set(i, " ");
            }
        }
    ...
    private void displaySpellsRightPage(Graphics g, float iconX, float iconY, float iconSize, float gap) {
        ...
        if (showRightPage) {
            ...
            if (SpellingSystem.knownSpells.get(spellKind) instanceof BurstSpell) {
                type = "Sort de souffle";
            } else if (SpellingSystem.knownSpells.get(spellKind) instanceof ExplosionSpell) {
                type = "Explosion";
            } else if (SpellingSystem.knownSpells.get(spellKind) instanceof ProjectileSpell) {
                type = "Projectile";
            } else if (SpellingSystem.knownSpells.get(spellKind) instanceof HealingSpell) {
                type = "Guérison";
            } else if (SpellingSystem.knownSpells.get(spellKind) instanceof PassiveSpell) {
                type = "Passif";
            }
            ...
            switch (type) {//damage and effects relative to the spell's type
                case "Sort de souffle":
                    String damagePoints = Integer.toString(((BurstSpell) SpellingSystem.knownSpells.get(spellKind)).getDamage());
                    damage = "Dégâts: " + damagePoints;
                    g.drawString(damage, iconX + iconSize + gap, iconY + 4 * gap);
                    break;

                case "Explosion":
                    damagePoints = Integer.toString(((ExplosionSpell) SpellingSystem.knownSpells.get(spellKind)).getDamage());
                    damage = "Dégâts: " + damagePoints;
                    g.drawString(damage, iconX + iconSize + gap, iconY + 4 * gap);
                    break;

                case "Projectile":
                    damagePoints = Integer.toString(((ProjectileSpell) SpellingSystem.knownSpells.get(spellKind)).getDamage());
                    damage = "Dégâts: " + damagePoints;
                    g.drawString(damage, iconX + iconSize + gap, iconY + 4 * gap);
                    break;

                case "Guérison":
                    String healingPoints = Integer.toString(((HealingSpell) SpellingSystem.knownSpells.get(spellKind)).getHealing());
                    effect = "Effet: " + healingPoints + " points de santé";
                    g.drawString(effect, iconX + iconSize + gap, iconY + 4 * gap);
                    break;

                case "Passif":
                    switch (SpellingSystem.knownSpells.get(spellKind).getName()) {
            ...
            switch (SpellingSystem.knownSpells.get(spellKind).getElement()) {
                case FIRE:
                    element = "Élément: Feu";
                    break;
            ...
            SpellingSystem.knownSpells.get(spellKind).getAnimation().draw(iconX + 10, iconY + 10, iconSize - (20*GameCore.SCALE), iconSize - (20*GameCore.SCALE)); 
    ...
    private void displayPotionsRightPage(Graphics g, float iconX, float iconY, float iconSize, float gap) {
        ...
        if (showRightPage) {
            icon.draw(iconX, iconY, iconSize, iconSize);
            name = "Nom: " + SpellingSystem.potionList.get(potionKind).getName();
            shortDescription = "Petite description: " + SpellingSystem.potionList.get(potionKind).getShortDescription();
            iconImage = SpellingSystem.potionList.get(potionKind).getIcon();
            element = "Élément: Aucun";

            switch (SpellingSystem.potionList.get(potionKind).getName()) {
                case "Potion de soin":
                    String healingPoints = Integer.toString(((HealingSpell) SpellingSystem.potionList.get(potionKind)).getHealing());
                    effect = "Effet: " + healingPoints + " points de santé";
                ...
                case "Potion d'acide":
                    String damagePoints = Integer.toString(((ProjectileSpell) SpellingSystem.potionList.get(potionKind)).getDamage());
                    damage = "Dégâts: " + damagePoints;
                    element = "Élément: Neutre";
            ...
            SpellingSystem.potionList.get(potionKind).getAnimation().draw(iconX + 10, iconY + 10, iconSize - (20*GameCore.SCALE), iconSize - (20*GameCore.SCALE)); 
            g.drawString(name, iconX + iconSize + gap, iconY);
